...
public class T72AVEntity extends SquadBaseVehicleEntity {

    public static final EntityDataAccessor<Float> STEERING_ANGLE =
            SynchedEntityData.defineId(T72AVEntity.class, EntityDataSerializers.FLOAT);

    public float prevSteeringAngle = 0.0F;
    public float wheelRotation = 0.0F;
    public float prevWheelRotation = 0.0F;

    public T72AVEntity(EntityType<? extends T72AVEntity> type, Level world) {
        super(type, world);
    }
    ...
    public void tick() {
        if (this.level().isClientSide) {
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.ClientAccess.handleT72AVClientTick(this)
            );
        }

        super.tick();

        // 2. Р“РµРЅРµСЂР°С†РёСЏ РґС‹РјР° РўР”Рђ РёР· РІС‹С…Р»РѕРїРЅРѕРіРѕ РєРѕР»Р»РµРєС‚РѕСЂР° СЃР»РµРІР° СЃР·Р°РґРё
        ...
        // 3. Р¤РёР·РёРєР° РїРѕРІРѕСЂРѕС‚Р° РіСѓСЃРµРЅРёС† Рё РєР°С‚РєРѕРІ
