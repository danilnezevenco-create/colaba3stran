...
public class bmd4Entity extends SquadBaseVehicleEntity {

    public int atgmShakeTicks = 0;

    public bmd4Entity(EntityType<? extends bmd4Entity> type, Level world) {
        super(type, world);
    }
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.ClientAccess.handleBmd4ClientTick(this)
            );
        }
    }
    ...
    private PlayState cannonFirePredicate(AnimationState<bmd4Entity> event) {
    ...
    private PlayState machineGunFirePredicate(AnimationState<bmd4Entity> event) {
