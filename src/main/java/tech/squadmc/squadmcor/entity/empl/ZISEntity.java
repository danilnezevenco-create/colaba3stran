...
public class ZISEntity extends GeoVehicleEntity {

    private static final EntityDataAccessor<Boolean> LOADED = SynchedEntityData.defineId(ZISEntity.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> RELOAD_COOLDOWN = SynchedEntityData.defineId(ZISEntity.class, EntityDataSerializers.INT);

    public ZISEntity(EntityType<? extends ZISEntity> type, Level world) {
        super(type, world);
    }
    ...
    public void tick() {
        ...
        // Р’С‹Р·РѕРІ РєР»РёРµРЅС‚СЃРєРѕР№ С‚СЂСЏСЃРєРё СЌРєСЂР°РЅР° РїСЂРё РІС‹СЃС‚СЂРµР»Рµ
        if (this.level().isClientSide) {
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.ClientAccess.handleZisClientTick(this)
            );
        }
    }
