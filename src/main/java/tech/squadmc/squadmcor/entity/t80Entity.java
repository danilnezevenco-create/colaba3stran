...
public class t80Entity extends SquadBaseVehicleEntity {

    public t80Entity(EntityType<? extends t80Entity> type, Level world) {
        super(type, world);
    }
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.ClientAccess.handleT80ClientTick(this)
            );
        }
    }
    ...
    private PlayState machineGunFirePredicate(AnimationState<t80Entity> event) {
