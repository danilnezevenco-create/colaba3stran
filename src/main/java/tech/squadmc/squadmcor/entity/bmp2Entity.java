...
public class bmp2Entity extends SquadBaseVehicleEntity {

    public int atgmShakeTicks = 0;

    public bmp2Entity(EntityType<? extends bmp2Entity> type, Level world) {
        super(type, world);
    }
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.ClientAccess.handleBmp2ClientTick(this)
            );
        }
    }
