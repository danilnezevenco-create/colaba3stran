...
public class FMTVEntity extends SquadBaseVehicleEntity {
    private static final EntityDataAccessor<Float> STEERING_ANGLE =
            SynchedEntityData.defineId(FMTVEntity.class, EntityDataSerializers.FLOAT);
    ...
    public void tick() {
        ...
        if (this.level().isClientSide) {
            ...
            net.minecraftforge.fml.DistExecutor.unsafeRunWhenOn(net.minecraftforge.api.distmarker.Dist.CLIENT, () -> () ->
                    tech.squadmc.squadmcor.client.sound.FMTVSoundManager.updateSounds(this)
            );
        }
    }
}
