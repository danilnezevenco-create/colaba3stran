...
public class m1a2sandReticleOverlay {
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        if (!(vehicle instanceof m1a2Entity_sand m1a2)) {
            return;
        }
    ...
    private static void drawDriverHud(GuiGraphics guiGraphics, Minecraft mc, m1a2Entity_sand m1a2, int width, int height) {
    ...
    private static void drawCommanderHud(GuiGraphics guiGraphics, Minecraft mc, m1a2Entity_sand m1a2, Player player, int width, int height) {
        int color = 0x00FFCC;
