...
public class Btr82ReticleOverlay {
    ...
    private static final ResourceLocation BTR82_SCOPE_TEXTURE = new ResourceLocation(squadmc.MODID, "textures/overlay/btr82_scope.png");
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        if (isFirstPerson || isZooming) {
            ...
            if (seatIndex == 0) {
                ...
                // РџСЂРёС†РµР»СЊРЅР°СЏ СЃРµС‚РєР° СЂР°СЃС‚СЏРіРёРІР°РµС‚СЃСЏ РІРѕ РІРµСЃСЊ СЌРєСЂР°РЅ (РІР»РµРІРѕ Рё РІРїСЂР°РІРѕ РґРѕ РєСЂР°РµРІ)
                guiGraphics.blit(BTR82_SCOPE_TEXTURE, 0, 0, 0, 0, screenWidth, screenHeight, screenWidth, screenHeight);
    ...
    private static void drawDriverHud(GuiGraphics guiGraphics, Minecraft mc, btr82Entity btr, int width, int height) {
        ...
        // РЎС‡РµС‚С‡РёРє СЃРєРѕСЂРѕСЃС‚Рё СЃРґРІРёРЅСѓС‚ Р»РµРІРµРµ (РєРѕРѕСЂРґРёРЅР°С‚Р° X РёР·РјРµРЅРµРЅР° СЃ 30 РЅР° 12)
    ...
    private static void drawGunnerHud(GuiGraphics guiGraphics, Minecraft mc, Player player, int width, int height) {
        ...
        // Р”Р°Р»СЊРЅРѕРјРµСЂ РІС‹РІРѕРґРёС‚СЃСЏ РїСЂСЏРјРѕ РїРѕРґ С†РµРЅС‚СЂР°Р»СЊРЅС‹Рј РїРµСЂРµРєСЂРµСЃС‚РёРµРј РїСЂРёС†РµР»Р°
