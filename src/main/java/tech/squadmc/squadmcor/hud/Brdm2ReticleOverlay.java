...
public class Brdm2ReticleOverlay {
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        if (!(vehicle instanceof brdmEntity btr)) {
            return;
        }
    ...
    private static void drawDriverHud(GuiGraphics guiGraphics, Minecraft mc, brdmEntity btr, int width, int height) {
