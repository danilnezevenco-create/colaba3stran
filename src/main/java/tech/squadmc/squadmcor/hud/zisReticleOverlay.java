...
public class zisReticleOverlay {
    ...
    // РџСѓС‚СЊ Рє РІР°С€РµР№ РєР°СЃС‚РѕРјРЅРѕР№ СЃРµС‚РєРµ РїСЂРёС†РµР»Р° ZiS-3
    private static final ResourceLocation ZIS_SCOPE_TEXTURE = new ResourceLocation(squadmc.MODID, "textures/overlay/t72_scope.png");
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        if (!(vehicle instanceof ZISEntity zis)) {
            return;
        }
        ...
        if (isFirstPerson || isZooming) {
            ...
            if (seatIndex == 0) {
                ...
                guiGraphics.blit(ZIS_SCOPE_TEXTURE, 0, 0, 0, 0, screenWidth, screenHeight, screenWidth, screenHeight);
