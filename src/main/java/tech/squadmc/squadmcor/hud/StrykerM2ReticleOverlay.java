...
public class StrykerM2ReticleOverlay {
    ...
    public static void onRenderGuiPre(RenderGuiEvent.Pre event) {
        ...
        if (!(vehicle instanceof StrykerM2Entity strykerm2)) {
            return;
        }
    ...
    private static void drawDriverHud(GuiGraphics guiGraphics, Minecraft mc, StrykerM2Entity strykerm2, int width, int height) {
    ...
    private static void drawCommanderHud(GuiGraphics guiGraphics, Minecraft mc, StrykerM2Entity strykerm2, Player player, int width, int height) {
        int color = 0x00FFCC;
