...
public class FenekEngineSoundInstance extends AbstractTickableSoundInstance {
    private final FenekEntity vehicle;
    ...
    public FenekEngineSoundInstance(FenekEntity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
