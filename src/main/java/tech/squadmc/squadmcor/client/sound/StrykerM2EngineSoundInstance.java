...
public class StrykerM2EngineSoundInstance extends AbstractTickableSoundInstance {
    private final StrykerM2Entity vehicle;
    private final boolean isFirstPerson;
    private final boolean isIdle;
    private boolean fadingOut = false;
    private float targetVolume = 1.0F;

    public StrykerM2EngineSoundInstance(StrykerM2Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
