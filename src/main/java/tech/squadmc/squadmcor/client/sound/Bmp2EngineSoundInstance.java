...
public class Bmp2EngineSoundInstance extends AbstractTickableSoundInstance {
    private final bmp2Entity vehicle;
    ...
    public Bmp2EngineSoundInstance(bmp2Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.BMP2_ENGINE_IDLE_1P.get() : ModSounds.BMP2_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.BMP2_ENGINE_RUNNING_1P.get() : ModSounds.BMP2_ENGINE_RUNNING_3P.get()),
