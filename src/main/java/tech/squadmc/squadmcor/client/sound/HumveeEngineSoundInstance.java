...
public class HumveeEngineSoundInstance extends AbstractTickableSoundInstance {
    private final HumveeEntity vehicle;
    ...
    public HumveeEngineSoundInstance(HumveeEntity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.HUMVEE_ENGINE_IDLE_1P.get() : ModSounds.HUMVEE_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.HUMVEE_RUNNING_1P_3P.get() : ModSounds.HUMVEE_RUNNING_1P_3P.get()),
        ...
        // РњРђРЁРРќР«: РЎС‚РѕРёС‚ = 20 (1.25F), Р•РґРµС‚ = 40 (2.5F)
        if (isFirstPerson) {
