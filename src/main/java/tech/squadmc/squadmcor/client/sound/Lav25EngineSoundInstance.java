...
public class Lav25EngineSoundInstance extends AbstractTickableSoundInstance {
    private final lav25Entity vehicle;
    private final boolean isFirstPerson;
    private final boolean isIdle;
    private boolean fadingOut = false;
    private float targetVolume = 1.0F;

    public Lav25EngineSoundInstance(lav25Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.LAV25_ENGINE_IDLE_1P.get() : ModSounds.LAV25_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.LAV25_ENGINE_RUNNING_1P.get() : ModSounds.LAV25_ENGINE_RUNNING_3P.get()),
