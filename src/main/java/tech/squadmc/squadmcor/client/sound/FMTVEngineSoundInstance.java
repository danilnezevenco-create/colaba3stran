...
public class FMTVEngineSoundInstance extends AbstractTickableSoundInstance {
    private final FMTVEntity vehicle;
    private final boolean isFirstPerson;
    private final boolean isIdle;
    private boolean fadingOut = false;
    private float targetVolume = 1.0F;

    public FMTVEngineSoundInstance(FMTVEntity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
