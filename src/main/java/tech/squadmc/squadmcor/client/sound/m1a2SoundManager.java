...
@OnlyIn(Dist.CLIENT)
public class m1a2SoundManager {
    private static final WeakHashMap<m1a2Entity, m1a2EngineSoundInstance> activeSounds = new WeakHashMap<>();

    public static void updateSounds(m1a2Entity vehicle) {
        if (vehicle.isRemoved() || !vehicle.isAlive() || !vehicle.isEngineStarted()) {
            m1a2EngineSoundInstance sound = activeSounds.remove(vehicle);
            if (sound != null) {
                sound.startFadeOut();
            }
            return;
        ...
        m1a2EngineSoundInstance currentSound = activeSounds.get(vehicle);
        ...
        if (currentSound == null || currentSound.isStopped() ||
            ...
            m1a2EngineSoundInstance newSound = new m1a2EngineSoundInstance(vehicle, isFirstPerson, isIdle);
