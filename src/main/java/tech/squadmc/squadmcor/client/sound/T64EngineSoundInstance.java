...
public class T64EngineSoundInstance extends AbstractTickableSoundInstance {
    private final T64Entity vehicle;
    ...
    public T64EngineSoundInstance(T64Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
