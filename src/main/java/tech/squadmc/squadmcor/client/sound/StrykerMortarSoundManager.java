...
@OnlyIn(Dist.CLIENT)
public class StrykerMortarSoundManager {
    private static final WeakHashMap<StrykerMortalEntity, StrykerMortarEngineSoundInstance> activeSounds = new WeakHashMap<>();

    public static void updateSounds(StrykerMortalEntity vehicle) {
        if (vehicle.isRemoved() || !vehicle.isAlive() || !vehicle.isEngineStarted()) {
            StrykerMortarEngineSoundInstance sound = activeSounds.remove(vehicle);
            if (sound != null) {
                sound.startFadeOut();
            }
            return;
        ...
        StrykerMortarEngineSoundInstance currentSound = activeSounds.get(vehicle);
        ...
        if (currentSound == null || currentSound.isStopped() ||
            ...
            StrykerMortarEngineSoundInstance newSound = new StrykerMortarEngineSoundInstance(vehicle, isFirstPerson, isIdle);
