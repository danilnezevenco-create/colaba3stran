...
public class Brdm2EngineSoundInstance extends AbstractTickableSoundInstance {
    private final brdmEntity vehicle;
    ...
    public Brdm2EngineSoundInstance(brdmEntity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.BRDM2_ENGINE_IDLE_1P.get() : ModSounds.BRDM2_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.BRDM2_ENGINE_RUNNING_1P.get() : ModSounds.BRDM2_ENGINE_RUNNING_3P.get()),
