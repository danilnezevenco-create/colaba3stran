...
public class Bmp1EngineSoundInstance extends AbstractTickableSoundInstance {
    private final Bmp1Entity vehicle;
    ...
    public Bmp1EngineSoundInstance(Bmp1Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.BMP1_ENGINE_IDLE_1P.get() : ModSounds.BMP1_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.BMP1_ENGINE_RUNNING_1P.get() : ModSounds.BMP1_ENGINE_RUNNING_3P.get()),
    ...
    public void tick() {
        ...
        if (this.isIdle) {
            ...
            this.pitch = Mth.clamp(0.8F + speedFactor, 0.8F, 1.3F);
        }
    }
