...
public class Btr82EngineSoundInstance extends AbstractTickableSoundInstance {
    private final btr82Entity vehicle;
    ...
    public Btr82EngineSoundInstance(btr82Entity vehicle, boolean isFirstPerson, boolean isIdle) {
        super(isIdle ?
                        (isFirstPerson ? ModSounds.BTR82_ENGINE_IDLE_1P.get() : ModSounds.BTR82_ENGINE_IDLE_3P.get()) :
                        (isFirstPerson ? ModSounds.BTR82_ENGINE_RUNNING_1P.get() : ModSounds.BTR82_ENGINE_RUNNING_3P.get()),
        ...
        // APC: РЎС‚РѕРёС‚ = 40 (2.5F), Р•РґРµС‚ = 80 (5.0F)
        if (isFirstPerson) {
            this.targetVolume = 1.0F;
        } else {
            this.targetVolume = isIdle ? 2.5F : 5.0F;
        }
